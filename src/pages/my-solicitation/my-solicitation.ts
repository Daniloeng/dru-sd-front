...
@IonicPage()
@Component({
  selector: 'page-my-solicitation',
  templateUrl: 'my-solicitation.html',
  providers: [ConsultaServiceProvider],
})
export class MySolicitationPage {
  ...
  ionViewWillEnter() {
    ...
    this.consultaService.getConsultabyReceiv(this.usuarioLogado.cpf, true).subscribe(
      response =>{
